      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td bgcolor="#FFFFFF" class="td_main6">
              <table width="558">
                <tr>
                  <td bgcolor="#FFFFFF" class="texto_destaque4"><p>ENVIE SUA MENSAGEM PARA O InterAÇÃO COM OS SEUS DADOS,<br />
                    QUE  AVISAREMOS VOC&Ecirc; POR 
                  EMAIL DO IN&Iacute;CIO DO NOSSO PROJETO<br />
                  DE APOIO
                  &Agrave; EDUCA&Ccedil;&Atilde;O JUDAICA! <br />
