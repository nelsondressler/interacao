...
<form action="<?php echo System::thisFile() ?>" method="post" onSubmit="return validaDados(this)">
  ...
  <table width="770" border="0" align="center" cellpadding="0" cellspacing="0" id="painel_subtitulo">
    <tr>
      <td><strong><img src="assets/img/ico_usuarios_b.gif" width="18" height="18" align="absmiddle" /></strong> Redes sociais</td>
    </tr>
  </table>
  <table width="770" border="0" align="center" cellpadding="0" cellspacing="0" class="table_form">
    <tr>
      <td width="74" height="30" class="input_title"> Facebook: </td>
      <td width="696" height="30"><input name="social_facebook" type="text" id="social_facebook" value="<? echo OpcoesHelper::get('social_facebook') ?>" size="100" /></td>
    </tr>
  </table>
  <br />
  <table width="770" border="0" align="center" cellpadding="0" cellspacing="0" id="painel_subtitulo">
    <tr>
      <td><img src="assets/img/chart_bar.png" width="16" height="16" align="absmiddle" /> Google Analytics </td>
    </tr>
</table>
  <table width="770" border="0" align="center" cellpadding="0" cellspacing="0" class="table_form">
    <tr>
      <td height="30" class="arial10">Cole abaixo o script que o google analytics.</td>
    </tr>
    <tr>
      <td height="30" class="input_title"><textarea name="google_analytics" cols="100" rows="5" class="requerido" id="google_analytics" style="width: 550px"><? echo OpcoesHelper::get('google_analytics') ?></textarea></td>
    </tr>
  </table>
  <?php
$acao = '';
