...
$conteudo_assets->selectOne('*', $conteudo_assets->getPrimaryKeyName() .'='. $cod);
...
if ($_POST['acao'] == 'cortar') {
  ...
  $conteudo_assets->update(array('arquivo'. $numero => $novo_nome), $conteudo_assets->getPrimaryKeyName() .'='. $cod);
