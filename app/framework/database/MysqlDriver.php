...
//    $this->connection = mysql_connect(DB_HOST .':'. DB_PORT, DB_USERNAME, DB_PASSWORD);
    $this->connection = mysqli_connect(DB_HOST, DB_USERNAME, DB_PASSWORD, DB_DATABASE, DB_PORT);
...
//          '</pre>';
    echo '<pre>
          ...
          <br><font color="#cc0000"><b>ERRO:</b></font> '. mysqli_connect_error() .
...
//    if ($results = mysql_query($sql, $this->connection)) {
    if ($results = mysqli_query($this->connection, $sql)) {
...
//        $this->total_rows = mysql_num_rows($results);
        $this->total_rows = mysqli_num_rows($results);
