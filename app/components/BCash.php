...
class BCash {
  ...
  public $email_loja  = 'info@interacao.gani.org.br';
  //public $email_loja  = 'nandotecbr@gmail.com';
  
  public function getUrlRetorno() {
    return SYS_SITE .'bcash-retorno.php';
  }
  
  public function getUrlAviso() {
    return SYS_SITE .'bcash-aviso.php';
  }
  ...
  public function checkout($row) {
    ...
    $html .= '<input name="url_retorno"     type="hidden" value="'. $this->getUrlRetorno() .'">'.$n;
    $html .= '<input name="url_aviso"       type="hidden" value="'. $this->getUrlAviso() .'">'.$n;
    ...
    $html .= '<input type="image" src="https://a248.e.akamai.net/f/248/96284/12h/www.bcash.com.br/webroot/img/bt_comprar.gif" value="Aquarde" alt="Aquarde" border="0" align="absbottom" >'.$n;
    $html .= '</form>';
