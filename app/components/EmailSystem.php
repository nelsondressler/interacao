...
class EmailSystem extends EmailSystemTemplate
{
  ...
  public function siteCadastro($cod_cliente = null) {
    ...
    if ($cod_cliente) {
      ...
      $to_email   = $row['email'];
      $to_name    = $row['nome'];
      $subject    = 'Bem-vindo ao projeto InterAЧУO';
      $body       = parent::emailHeader('Seu cadastro na InterAчуo', $html);
  ...
  public function enviaAssinaturaManual($row, $html) {
    ...
    if ($row) {
      ...
      $to_email   = $row['email'];
      $to_name    = $row['nome'];
      $subject    = 'Finalizaчуo de Assinatura';
      $body       = parent::emailHeader('Finalizaчуo de Assinatura', $html);
