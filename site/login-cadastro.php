                      ...
                      <table width="500" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <span id="indicacao_texto">&nbsp;</span>
                              <input name="indicacao_qual" type="text" value="<? echo $row['indicacao_qual'] ?>" style="width:150px" maxlength="100" class="form" /></td>
                        </tr>
                      </table>
                      <br />
                      <table width="500" border="0" cellpadding="0" cellspacing="0">
...
<?php } ?>
      ...
      <td width="324" valign="top" bgcolor="#FFFFFF"><table width="300" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="center"><img src="assets/images/planos/bcash.jpg" alt="" width="87" height="56" /></td>
          </tr>
        </table>
