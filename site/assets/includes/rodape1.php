                      ...
                      <table width="114" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          for ($j = 0; $j < count($row_assets); $j++) {
                            ...
                            echo '<a '. $link .'><img src="'.  SYS_SITE_CONTEUDO .'uploads/'. $row_assets[$j]['arquivo1'] .'" width="132" height="102"/></a>';
                          }
                          ?>
                          </td>
                        </tr>
              ...
              <tr>
                <td class="td_logos_parceiros">
                  ...
                  for ($j = 0; $j < count($row_assets); $j++) {
                    ...
                    $link = '';
                    if ($row_assets[$j]['link']) {
                      $link = 'onclick="window.open(\''. $row_assets[$j]['link'] .'\')"  style="cursor: pointer;"';
                    }
