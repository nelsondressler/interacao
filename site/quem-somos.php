...
$row_texto = $conteudo->exibeConteudo( $conteudo->getCodTipo() );
?>
  ...
  <table width="980" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="4" class="bg_top_main2"><table width="972" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="td_main5"><?php echo $row_texto['nome'] ?> <br /> <span class="td_main2"><?php echo $row_texto['descricao'] ?></span></td>
    ...
    <tr>
      ...
      <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td valign="top" bgcolor="#FFFFFF" class="td_main6a area_editor">
            <?php echo $row_texto['texto1'] ?>
            </td>
          </tr>
      </table></td>
