<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><table width="980" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="220" height="120"><a href="<?php echo SYS_SITE?>"><img src="assets/images/Logo_IA.png" width="220" height="120" border="0"/></a></td>
    <td width="610">
      <nav class="primary">
